...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        small_worker_count=int(os.getenv("VIVEKA_SMALL_WORKER_COUNT", "6")),
        medium_worker_count=int(os.getenv("VIVEKA_MEDIUM_WORKER_COUNT", "6")),
        large_worker_count=int(os.getenv("VIVEKA_LARGE_WORKER_COUNT", "8")),
